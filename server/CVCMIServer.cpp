...
CVCMIServer::CVCMIServer(boost::program_options::variables_map & opts)
	: LobbyInfo(), port(3030), io(new boost::asio::io_service()), shm(nullptr), upcomingConnection(nullptr), state(EServerState::LOBBY), cmdLineOptions(opts), currentClientId(1), currentPlayerId(1), restartGameplay(false)
{
